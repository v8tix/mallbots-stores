...
func (m *Module) Startup(ctx context.Context, mono monolith.Monolith) (err error) {
	...
	if err = pb.RegisterAsyncAPI(mono.Mux()); err != nil {
		return err
	}
